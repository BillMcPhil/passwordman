...
function PasswordDisplay({ website, username, password }) {
...
export default function Home() {
  ...
  const handleEntry = (e) => {
    ...
    setEntries(entries.concat(<PasswordDisplay key={entries.length} website={inputs.website} username={inputs.username} password={inputs.password} />));
